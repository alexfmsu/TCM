...
def make_plot3D(t, ww, w, state):
	...
	ax.plot_wireframe(ww, t, w,  rstride=5, alpha=0.8, color='#777777')
	...
	# ax.plot_surface(ww, t, w, rstride=1, cmap=cm.bone, alpha=0.3, lw=0.1, antialiased=True)
...
def make_plot(x, xmin, xmax, ymin, ymax, data, color='blue', title='title', X=r'$t,\ мкс$', Y=r'$Amplitude$   ', rotation=90):
	...
	plt.plot(x, data**2, linewidth = 0.75, antialiased = True, solid_joinstyle='round', color=color)
...
def make_plotdiff(x, xmin, xmax, ymin, ymax, data, color='blue', title='title', X=r'$t,\ мкс$', Y=r'$Amplitude$   ', rotation=90):
	...
	ymax = np.max(data)
	plt.plot(x, data, linewidth = 0.75, antialiased = True, solid_joinstyle='round', color=color)
...
def make_plot2(x, xmin, xmax, ymin, ymax, data1, data2, title='title', X='X', Y='Y'):
	...
	plt.plot(x, data1 ** 2, linewidth = 0.75, antialiased = True, solid_joinstyle='round', color="blue", label="RWA")
	plt.plot(x, data2 ** 2, linewidth = 0.75, antialiased = True, solid_joinstyle='round', color="red", label="Exact")
...
def make_plot2w(x, xmin, xmax, ymin, ymax, data1, data2, init_state, st1, st2, title='title', X='X', Y='Y'):
	...
	plt.plot(x, data1 ** 2, linewidth = 0.75, antialiased = True, solid_joinstyle='round', color="blue", label=st1)
	plt.plot(x, data2 ** 2, linewidth = 0.75, antialiased = True, solid_joinstyle='round', color="red", label=st2)
